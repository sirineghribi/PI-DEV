    ...
    public static void main(String[] args) {
        ...
        UtilisateurService ut = new  UtilisateurService();
          CarteService c = new CarteService();
             ...
             Utilisateur u1 = new Utilisateur("bm","zeineb",Genre.femme,"zeinebbm@gmail.com","zz",Date.valueOf("2001-06-26") );
             Utilisateur u2 = new Utilisateur("mn","imen",Genre.femme,"imenmn@gmail.com","ii",Date.valueOf("2002-06-26") );
              Utilisateur u10= new Utilisateur("l","zied",Genre.homme,"zied@gmail.com","ss",Date.valueOf("2002-06-26"),Roles.A );
             Utilisateur u4=new Utilisateur();
             //System.out.println(c.findById_u(1));
        // ut.ajouter(u10);
        ...
        Vol v3=new  Vol(2,2,"moon", "planifié", 300,Date.valueOf("2023-06-11") );
        //vs.ajouter(v3);
       // vs.supprimer(v3);
      ...
      //vs.modifier(v3);
        System.out.println(vs.getAll()); 
        Utilisateur u3 = new Utilisateur(1,"mn","imen",Genre.femme,"imenmn@gmail.com","ii",Date.valueOf("2002-06-26") );
         Utilisateur u9= new Utilisateur(2,"mn","imen",Genre.femme,"imenmn@gmail.com","ii",Date.valueOf("2002-06-26"));
        ReservationService rs=new ReservationService();
        Reservation r1=new Reservation(1,  143000000, 20000000,1, Date.valueOf("2023-12-12"),v3, u9 );
            Reservation r2=new Reservation(3,  143000000, 20000000,1, Date.valueOf("2023-12-12"),v3, u9 );
        //rs.ajouter(r2);
