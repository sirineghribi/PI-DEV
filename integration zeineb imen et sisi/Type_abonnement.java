...
public class Type_abonnement implements Comparable<Type_abonnement>{
    ...
    public Type_abonnement(String nom, String description, float periode, float offre) {
        this.nom = nom;
    ...
    public Type_abonnement(int id, String nom, String description, float periode, float offre) {
        this.id = id;
        this.nom = nom;
        this.description = description;
        this.periode = periode;
    ...
    public String toString() {
        return "Type abonnement{id=" + id + "|nom=" + nom + "|description=" + description + "|periode=" + periode + "|offre=" + offre+"}";
    }
