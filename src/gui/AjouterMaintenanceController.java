...
public class AjouterMaintenanceController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        vs.getAll().forEach((t)->vehicule.getItems().add(t.getNom_vh()));
    }    
    ...
    private void ajoutermaintenance(ActionEvent event) {
        ...
        V=new Vehicule (5, 45);
         try {
            ...
            V=new VehiculeServices().getAll().stream().filter(t->t.getNom_vh().equals(vehicule.getValue())).collect(Collectors.toList()).get(0);
