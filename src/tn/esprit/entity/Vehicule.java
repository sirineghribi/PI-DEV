...
public class Vehicule {
    ...
    public Vehicule(int id,String nom_vh, CategorieVehicule CategorieVehicule, float poid, int vitesse, int passager, Maintenance maintenance){
        this.id_vehicule=id; this.nom_vh=nom_vh; this.CategorieVehicule=CategorieVehicule; this.poid_sup=poid; this.vitesse=vitesse;
        this.nbr_pas=passager; this.maintenance=maintenance; 
    }
    ...
    public Vehicule(String nom_vh, CategorieVehicule CategorieVehicule, float poid_sup, int vitesse, int nbr_pas, Maintenance maintenance) {
        this.nom_vh=nom_vh;
    ...
    public String toString() {
        return "Vehicule{" + "id_vehicule=" + id_vehicule + ", CategorieVehicule=" + CategorieVehicule + ", poid_sup=" + poid_sup + ", vitesse=" + vitesse + ", nbr_pas=" + nbr_pas + ", maintenance=" + maintenance + '}';
    }  
}
