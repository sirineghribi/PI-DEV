...
public class Pidev3a27 {
    ...
    public static void main(String[] args) {
        ...
        Vehicule p1 = new Vehicule(10,"spaceV",c1,(float)1.2,9,7,m1);
        Vehicule p2 = new Vehicule("spaceT",c2,(float)1.2,9,7,m1); //(int id, CategorieVehicule CategorieVehicule, float poid, int vitesse, int passager, Maintenance maintenance)
      //  vs.ajouter(p2);
