    ...
    public static void main(String[] args) {
          ...
          Utilisateur u1 = new Utilisateur("bm","zeineb","femme","zeinebbm@gmail.com","zz",Date.valueOf("2001-06-26") );
           Utilisateur u2 = new Utilisateur("mn","imen","femme","imenmn@gmail.com","ii",Date.valueOf("2002-06-26") );
            Utilisateur u3 = new Utilisateur(5,"mn","imen","femme","imenmn@gmail.com","ii","a",Date.valueOf("2002-06-26") );
            Utilisateur u4 = new Utilisateur("bm","zeineb","femme","zeinebbm@gmail.com","zz",Date.valueOf("2001-06-26") );
